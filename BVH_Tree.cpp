...
void BVH_Tree::build_ObjectSplit_Recursively(Primitive* prim_list, size_t size) {
	root = new Node;
...
void BVH_Tree::build_ObjectSplit_Multithreaded_start() {
	
	ThreadPool<temp_args> pool(4, build_ObjectSplit_Multithreaded);
	Node* root = new Node;
}


void BVH_Tree::build_ObjectSplit_Multithreaded(temp_args temp) {
